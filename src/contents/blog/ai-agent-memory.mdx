...
- GibsonAI/Memori API Key ([get here](https://memoriapp.gibsonai.com/)) - format: `mk_...`, required for authentication and provides intelligent memory compression (40-60% token savings)
...
![Multi-tenant AI agent architecture showing three services: GibsonAI authentication, DigitalOcean Gradient AI, and PostgreSQL database with their connections](https://res.cloudinary.com/iambigmomma/image/upload/v1763479367/blog/ai-agent-memory/multi-agent-ai-agent-architecture.png)
...
1. **GibsonAI API Key** (`mk_...`)
   ...
   - Get yours at [memoriapp.gibsonai.com](https://memoriapp.gibsonai.com/)
...
| Table                  | Purpose                                                    |
| ---------------------- | ---------------------------------------------------------- |
| `registered_domains`   | Maps domain names to GibsonAI API keys                     |
...
<details>
<summary><strong>Refresh the agent access key (click to expand)</strong></summary>

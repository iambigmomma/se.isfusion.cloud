...
- ✅ Uses DigitalOcean Gradient AI + [Memori Python SDK](https://github.com/MemoriLabs/Memori) (open source) for persistent memory
- ✅ Deploys with FastAPI + PostgreSQL + embeddable JavaScript widget

**Time:** 25-30 minutes | **Cost:** ~$10-20/month | **Level:** Intermediate

**Source code:** [https://github.com/Boburmirzo/customer-support-agent-memory](https://github.com/Boburmirzo/customer-support-agent-memory)
...
_Assumptions: 2 conversations/user/month, 10 message pairs per conversation_
...
![When to use memory-powered AI agents - comparison of good use cases vs scenarios to avoid](https://res.cloudinary.com/iambigmomma/image/upload/v1763474319/blog/ai-agent-memory/memory-powered-agent.png)
...
![AI agent conversation flow diagram showing 5 steps: user input, memory retrieval, knowledge base query, AI generation, and memory storage](https://res.cloudinary.com/iambigmomma/image/upload/v1763478267/blog/ai-agent-memory/ai-agent-memory-conversation-flow-with-memory.png)
...
3. **Persistent Memory** - [Memori Python SDK ](https://github.com/MemoriLabs/Memori)integration that remembers conversations across sessions
...
- [DigitalOcean account](https://cloud.digitalocean.com/login) with [Gradient AI access](https://www.digitalocean.com/products/gradientai/platform)
...
**Note:** The default AI model is Llama-3.2-3B-Instruct (fast, cost-effective). You can find other model IDs in your [DigitalOcean Gradient AI Console](https://cloud.digitalocean.com/gradient-ai/models).
...
Both containers should show `Up` status. API documentation is available at [http://localhost:8000/docs](http://localhost:8000/docs)
...
![Multi-tenant AI agent architecture showing services: DigitalOcean Gradient AI and PostgreSQL database with their connections](https://res.cloudinary.com/iambigmomma/image/upload/v1763479367/blog/ai-agent-memory/multi-agent-ai-agent-architecture.png)
...
<details>
<summary><strong>Widget Configuration Options (click to expand)</strong></summary>   
...
**Product Demo:** [http://localhost:8000/static/product_demo.html](http://localhost:8000/static/product_demo.html)
...
![Product demo screenshot showing the customer support widget with conversation history demonstrating memory features](https://res.cloudinary.com/iambigmomma/image/upload/v1763469811/blog/ai-agent-memory/customer-support-agent-memory-conversation.png)
...
![AI agent with memory applications across different industries: healthcare, finance, e-learning, travel, real estate, and retail](https://res.cloudinary.com/iambigmomma/image/upload/v1763470803/blog/ai-agent-memory/ai-agent-memory.png)
...
- Memori SDK not properly configured
...
```bash
# Check that user_id is being passed consistently
# Memory requires the same user_id across sessions
...
**Source code:** [github.com/Boburmirzo/customer-support-agent-memory](https://github.com/Boburmirzo/customer-support-agent-memory)

**Platform:** [DigitalOcean Gradient AI](https://www.digitalocean.com/products/gradientai/platform)
